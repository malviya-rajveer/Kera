  ...
  return (
    <section className="flex min-h-screen w-full justify-center bg-black">
      <div className="relative flex w-6xl">
        ...
        {/* <div className="absolute top-20 left-0 h-150 w-px bg-[repeating-linear-gradient(_to_bottom,rgba(255,255,255,0.4)_0px,rgba(255,255,255,0.4)_6px,transparent_6px,transparent_12px)] [mask-image:linear-gradient(to_bottom,transparent_0%,black_15%,black_90%,transparent_100%)]" /> */}
        {/* <div className="absolute top-20 right-117 h-150 w-px bg-[repeating-linear-gradient(_to_bottom,rgba(255,255,255,0.5)_0px,rgba(255,255,255,0.5)_6px,transparent_6px,transparent_12px)] [mask-image:linear-gradient(to_bottom,transparent_0%,black_15%,black_90%,transparent_100%)]" /> */}
        {/* <div className="absolute top-20 right-35 h-150 w-px bg-[repeating-linear-gradient(_to_bottom,rgba(255,255,255,0.5)_0px,rgba(255,255,255,0.5)_6px,transparent_6px,transparent_12px)] [mask-image:linear-gradient(to_bottom,transparent_0%,black_15%,black_90%,transparent_100%)]" /> */}
        {/* <div className="absolute top-20 right-0 h-150 w-px bg-[repeating-linear-gradient(_to_bottom,rgba(255,255,255,0.4)_0px,rgba(255,255,255,0.4)_6px,transparent_6px,transparent_12px)] [mask-image:linear-gradient(to_bottom,transparent_0%,black_15%,black_90%,transparent_100%)]" /> */}
